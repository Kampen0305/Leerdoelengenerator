...
export function EducationGuidance({ context, aiReadyObjective }: EducationGuidanceProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      <div className="mb-6">
        <h3 className="text-lg font-semibold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent flex items-center mb-2">
        ...
        {sections.map((section, index) => (
          <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
            <button
              ...
              className="w-full px-4 py-3 bg-gradient-to-r from-secondary/5 to-accent/5 border-b border-slate-200 flex items-center justify-between hover:from-secondary/10 hover:to-accent/10 transition-colors"
            >
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-secondary/5 to-accent/5 border border-secondary/20 rounded-lg">
        <h4 className="font-medium text-secondary-dark mb-3 flex items-center">
          <CheckCircle className="w-4 h-4 mr-2" />
          Implementatie Stappenplan
        </h4>
        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div className="bg-white rounded-lg p-3 border border-secondary/20">
            <div className="font-medium text-secondary-dark mb-1">Week 1-2: Voorbereiding</div>
          ...
          <div className="bg-white rounded-lg p-3 border border-accent/20">
            <div className="font-medium text-accent-hover mb-1">Week 3-6: Introductie</div>
          ...
          <div className="bg-white rounded-lg p-3 border border-primary/20">
            <div className="font-medium text-primary mb-1">Week 7+: Verdieping</div>
