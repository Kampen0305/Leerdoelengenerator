...
import DigitEdPromo from "@/components/DigitEdPromo";
  ...
  return (
    <footer className="mt-8">
      ...
      <div
        ...
        className="w-full h-12 md:h-14 flex items-center justify-center px-4 text-xs sm:text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-sm hover:shadow-md transition-shadow"
      >
