          ...
          {filteredObjectives.length === 0 ? (
            ...
            <div className="grid gap-4">
              {filteredObjectives.map((objective) => (
                <div key={objective.id} className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-200">
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-sm font-medium text-accent-pop mb-1">Origineel:</p>
                      <p className="text-sm text-gray-700">{objective.originalObjective}</p>
                    </div>

                    <div>
                      <p className="text-sm font-medium text-secondary-dark mb-1">AI-ready:</p>
                  ...
                  <div className="flex justify-end space-x-2 mt-4 pt-3 border-t border-gray-100">
                    <button
                      ...
                      className="flex items-center space-x-1 bg-gradient-to-r from-secondary to-secondary-dark text-white px-3 py-1 rounded text-sm hover:from-secondary-dark hover:to-secondary-dark transition-colors shadow-md hover:shadow-lg"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1 bg-accent-pop text-white px-3 py-1 rounded text-sm hover:bg-accent-pop/90 transition-colors shadow-md hover:shadow-lg"
                    >
